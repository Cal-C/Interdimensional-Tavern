export const Cards = [
    {
        ...
        playType : "SingleTargetAttack", //type is an external reference to the type of card, it can be used to see what other cards can interact with it
    ...
    },
    {
        ...
        cashCost : -1, //this is a cost since it always affects the player of the card, not the target
        drunkennessEffect : -1,
    }
]