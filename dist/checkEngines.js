...
dependencies.forEach(dep => {
  try {
    ...
    console.log("Dependency: ".concat(dep));
    console.log("Engines: ".concat(JSON.stringify(depPackageJson.engines, null, 2)));
  } catch (error) {
    console.error("Failed to read package.json file for dependency ".concat(dep));
  }
});